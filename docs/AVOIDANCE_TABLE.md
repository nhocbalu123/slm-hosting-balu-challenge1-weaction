...
| 8   | No timeout or fallback       | Provider client has timeouts and falls back from vLLM to Ollama for provider outages, while provider request errors avoid fallback    | stop vLLM and show fallback response                   |
